...
public class SystemInfoService {
    ...
    public void dropComputeNode(String host, int heartbeatPort)
        ...
        // log
        GlobalStateMgr.getCurrentState().getEditLog().logDropComputeNode(dropComputeNode);
    ...
    public void replayDropComputeNode(ComputeNode computeNode) {
        ...
        // update cluster
        final Cluster cluster = GlobalStateMgr.getCurrentState().getCluster(computeNode.getOwnerClusterName());
        if (null != cluster) {
